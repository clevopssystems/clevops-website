...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const hubPages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${BASE_URL}/seo-services-dallas`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/website-design-houston`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/seo-services-houston`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/website-design-austin`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/seo-services-austin`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.9,
    },
